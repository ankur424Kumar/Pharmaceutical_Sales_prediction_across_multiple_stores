...
train_data_merged = pd.read_csv(r"C:\Users\HunterAK\Digicrome\NextHike\Project 2\train_df.csv")
test_data_merged = pd.read_csv(r"C:\Users\HunterAK\Digicrome\NextHike\Project 2\test_df.csv")
...
# Assuming you have the run_id
run_id = "e6044e3507c94766bef99ba15c5ab673"

# Fetch the run using mlflow API
run = mlflow.get_run(run_id)

# List artifacts for the run
artifacts = mlflow.search_runs(run.info.run_id)
